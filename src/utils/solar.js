...
// NOAA-based subsolar point: the geographic (lat, lon) where the sun is at
// zenith for a given instant. Accurate to a few arc-minutes, dependency-free.
...
// Equirectangular (lat, lon in degrees) -> position on a three.js SphereGeometry
// of the given radius. Matches three's default sphere UV layout so the standard
// earth textures, the sun direction and surface markers all stay aligned.
...
// World-space unit vector pointing from the globe centre toward the sun.
